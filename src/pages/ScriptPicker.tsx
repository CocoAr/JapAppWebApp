    ...
    <div>
      ...
      <div className="script-picker-grid">
        <Link to="/app/hiragana" className="script-picker-tile script-picker-tile--hiragana">
          ...
          <span className="muted script-picker-tile-desc">Material en hiragana (niveles y temas actuales)</span>
        </Link>
        <Link to="/app/katakana" className="script-picker-tile script-picker-tile--katakana">
          ...
          <span className="muted script-picker-tile-desc">Palabras en katakana (外来語) por nivel</span>
        </Link>
      </div>
    </div>
  );
